...
public class PgEnvironmentBuilderWindows : IPgEnvironmentBuilder
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var sqlClient = sqlclientFactory("psql.exe", instanceConfig);
        ...
        return new PgEnvironment
        {
            ...
            InitDb = initDbControllerFactory("initdb.exe", instanceConfig),
            Controller = dataClusterControllerFactory("pg_ctl.exe", instanceConfig),
